...
import (
	"github.com/alangotbithin/vc-go/crypto-ext/verifiers/bbs"
	"github.com/alangotbithin/vc-go/crypto-ext/verifiers/ecdsa"
	"github.com/alangotbithin/vc-go/crypto-ext/verifiers/ed25519"
	"github.com/alangotbithin/vc-go/crypto-ext/verifiers/rsa"
	...
	"github.com/alangotbithin/vc-go/proof/jwtproofs/es256"
	"github.com/alangotbithin/vc-go/proof/jwtproofs/es256k"
	"github.com/alangotbithin/vc-go/proof/jwtproofs/es384"
	"github.com/alangotbithin/vc-go/proof/jwtproofs/es521"
	"github.com/alangotbithin/vc-go/proof/jwtproofs/ps256"
	"github.com/alangotbithin/vc-go/proof/jwtproofs/rs256"
	...
	"github.com/alangotbithin/vc-go/proof/ldproofs/ecdsasecp256k1signature2019"
	"github.com/alangotbithin/vc-go/proof/ldproofs/ed25519signature2018"
	"github.com/alangotbithin/vc-go/proof/ldproofs/ed25519signature2020"
	"github.com/alangotbithin/vc-go/proof/ldproofs/jsonwebsignature2020"
